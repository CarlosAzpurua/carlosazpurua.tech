<script lang="ts">
  ...
  let title = 'Carlos Azpurua | Software Developer';
  let description =
    'A Software Developer interested in Systems Programming and Web Development.';
  let avatarUrl = 'https://avatars.githubusercontent.com/u/42218136?v=4';
...
<svelte:head>
  ...
  <meta name="instagram:image:src" content={avatarUrl} />
</svelte:head>
    ...
    <ul class="flex py-4 mx-auto md:mx-0">
      <li class="mr-4">
        <a
          ...
          href="https://es.stackoverflow.com/users/306337/carlos-azpurua"
          target="_blank"
        >
      ...
      <li class="mr-4">
        <a
          rel="noopener noreferrer"
          href="https://www.linkedin.com/in/carlosazpurua/?locale=en_US"
          target="_blank"
        >
      ...
      <li class="mr-4">
        <a
          rel="noopener noreferrer"
          href="https://www.instagram.com/charlietechoficial/"
          target="_blank"
        >
      ...
      <li class="mr-4">
        <a
          rel="noopener noreferrer"
          href="https://carlosazpurua.itch.io"
          target="_blank"
        >
